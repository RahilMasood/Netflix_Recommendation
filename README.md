...
- Provides top `n` similar results (both movies and TV shows).
...
Make sure your dataset (`netflix_data.csv`) is properly formatted and stored at the correct path.
